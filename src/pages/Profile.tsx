...
const Profile = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (universityInputRef.current && !universityInputRef.current.closest('.relative')?.contains(event.target as Node)) {
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <div className="relative">
                          ...
                          <Input
                            ...
                            placeholder={goalsData.dream_university && goalsData.dream_university !== 'other'
                              ? universities.find(u => u.value === goalsData.dream_university)?.label || goalsData.dream_university
                              : t('profile_search_universities')
                            }
                      ...
                      {goalsData.dream_university && goalsData.dream_university !== 'other' && (
                        <div className="flex items-center gap-2 mt-2">
                          <Badge variant="secondary" className="text-xs">
                            {universities.find(u => u.value === goalsData.dream_university)?.label || goalsData.dream_university}
                            <button
                              type="button"
                              onClick={() => setGoalsData({ ...goalsData, dream_university: '', dream_university_other: '' })}
